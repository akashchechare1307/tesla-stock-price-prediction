&family=Rajdhani    &amp;family=Rajdhanist.markdown("""<style>@import url('https://fonts.googleapis.com/css2?family=Orbitron:wght@400;700;900&family=Rajdhani:wght@300;400;500;600;700&display=swap');* { font-family: 'Rajdhani', sans-serif; }@keyframes gradientAnim { 0%{background-position:0% 50%} 50%{background-position:100% 50%} 100%{background-position:0% 50%} }@keyframes neonGlow { 0%,100%{text-shadow:0 0 10px #00d4ff,0 0 20px #00d4ff,0 0 30px #00d4ff,0 0 40px #00d4ff} 50%{text-shadow:0 0 5px #0099ff,0 0 10px #0099ff,0 0 15px #0099ff,0 0 20px #0099ff} }@keyframes cardFloat { 0%,100%{transform:translateY(0px)} 50%{transform:translateY(-5px)} }body { background: #000000; }.stApp { background-color: transparent !important; }.main-title { font-family: 'Orbitron', sans-serif; font-size: 3.5rem; font-weight: 900; text-align: center; background: linear-gradient(90deg, #00d4ff, #0099ff, #ffff00, #00d4ff); background-size: 300% 300%; -webkit-background-clip: text; -webkit-text-fill-color: transparent; animation: gradientAnim 5s ease infinite, neonGlow 3s ease infinite; margin-bottom: 1rem; color: #ffffff; margin-bottom: 2rem; letter-spacing: 2px; }.glow-card { background: linear-gradient(135deg, rgba(0,212,255,0.1), rgba(0,153,255,0.1)); border: 1px solid rgba(0,212,255,0.3); border-radius: 20px; padding: 20px; transition: all 0.3s ease; animation: cardFloat 3s ease infinite; }.glow-card:hover { border-color: #00d4ff; box-shadow: 0 0 30px rgba(0,212,255,0.5), 0 0 60px rgba(0,212,255,0.3); transform: translateY(-8px) scale(1.02); }.stat-number { font-family: 'Orbitron', sans-serif; font-size: 2.5rem; font-weight: 700; background: linear-gradient(90deg, #00d4ff, #0099ff); -webkit-background-clip: text; -webkit-text-fill-color: transparent; text-align: center; }.stat-label { text-align: center; color: #ffffff; font-size: 0.9rem; letter-spacing: 2px; text-transform: uppercase; }.sidebar-card { background: rgba(255,255,255,0.03); border-radius: 15px; padding: 15px; margin-bottom: 20px; border-left: 3px solid #00d4ff; }.sidebar-title { color: #00d4ff; font-weight: 700; font-size: 1.1rem; margin-bottom: 10px; letter-spacing: 1px; }.stButton>button { background: linear-gradient(90deg, #00d4ff, #0099ff); border: none; border-radius: 10px; padding: 10px 30px; font-weight: 700; letter-spacing: 1px; text-transform: uppercase; transition: all 0.3s ease; }.stButton>button:hover { box-shadow: 0 0 20px rgba(0,212,255,0.5); transform: scale(1.05); }.css-1l02zno { background: rgba(0,0,0,0.2); }section[data-testid="stSidebar"] { background: linear-gradient(180deg, rgba(10,10,30,0.95), rgba(20,10,40,0.95)); border-right: 1px solid rgba(0,212,255,0.2); }</style>""", unsafe_allow_html=True)
...
color: #aaaacc; margin-bottom: 2rem; letter-spacing: 2px; }.glow-card { background: linear-gradient(135deg, rgba(0,212,255,0.1), rgba(0,153,255,0.1)); border: 1px solid rgba(0,212,255,0.3); border-radius: 20px; padding: 20px; transition: all 0.3s ease; animation: cardFloat 3s ease infinite; }
